  ...
  <div id="app">
    <section>
      ...
      <div class="row justify-content-center mt-4">
        <input type="text" v-model="inputField" v-on:keyup.enter='addNum' class='mr-1' placeholder="Please input number">
...
<script>
import { addNumParams, getTotalNumParams } from './server_pb'
import { addNumServiceClient } from './server_grpc_web_pb'
